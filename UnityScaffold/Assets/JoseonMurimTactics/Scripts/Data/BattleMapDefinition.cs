...
namespace JoseonMurimTactics
{
    ...
    public sealed class BattleMapDefinition : ScriptableObject
    {
        ...
        public List<BattleInteractableDefinition> interactables =
            new List<BattleInteractableDefinition>();
        ...
        public List<BattleReinforcementRule> reinforcementRules =
            new List<BattleReinforcementRule>();
