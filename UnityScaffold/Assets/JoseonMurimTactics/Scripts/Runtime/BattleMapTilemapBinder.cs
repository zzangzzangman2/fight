...
public sealed class BattleMapTilemapBinder : MonoBehaviour
{
    ...
    private TacticalGridCellData CreateCellData(Vector3Int tileCell, TerrainTileData terrainTile)
    {
        ...
        return new TacticalGridCellData
        {
            ...
            blocksProjectiles = terrainTile != null && terrainTile.blocksProjectiles,
            ...
            coverBonus = terrainTile == null ? 0 : terrainTile.coverBonus,
            ...
            deployZone = terrainTile == null ? 0 : terrainTile.deployZone,
            occupyAllowed = terrainTile == null || terrainTile.occupyAllowed,
