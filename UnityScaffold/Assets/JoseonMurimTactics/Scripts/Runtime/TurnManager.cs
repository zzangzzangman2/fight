...
public sealed class TurnManager : MonoBehaviour
{
    ...
    public IReadOnlyList<CombatantRuntime> TurnOrder
    {
        get {
            return turnOrder;
        }
    }
    public CombatantRuntime ActiveUnit
    {
        get {
            return turnOrder.Count == 0 ? null : turnOrder[currentIndex];
        }
    }
    public int Round
    {
    ...
    public TerrainResolver TerrainResolver
    {
        get {
            return terrainResolver;
        }
    }
