...
namespace JoseonMurimTactics
{
    public sealed class MovementResolver
    {
        ...
        public bool IsInside(Vector2Int cell)
        {
            ...
            return cell.x >= map.origin.x &&
                cell.y >= map.origin.y &&
                cell.x < map.origin.x + map.size.x &&
        ...
        public Dictionary<Vector2Int, int> GetReachableCells(Vector2Int start, int movementBudget, bool includeStart = false)
        {
        ...
        public bool TryProjectPush(Vector2Int start, Vector2Int direction, int distance, out Vector2Int destination, out bool fell, out bool blocked)
        {
            destination = start;
            fell = false;
            blocked = false;
