...
public static class BattleTestSceneLauncher
{
    ...
    private static void CreateController()
    {
        ...
        controller.unitDefinitions = new[] {
            Unit("park_sungjun", "박성준", Faction.Ally, "park_sungjun_visual.asset", new Vector2Int(7, 8),
                 "백두산 백두검문", 17, "ENTP", "빛", "검", "능청스럽지만 결정적 순간에는 단호함", 36, 5, 15, 16, 4, 1,
                 7, 15, 6, 10, "백두광검", 1, 0, 1, 5, 2, BattleSpecialEffect.Mark),
            Unit("baek_ryeon", "백련", Faction.Ally, "baek_ryeon_visual.asset", new Vector2Int(6, 9), "강원 설악창문",
                 17, "INFJ", "얼음/서리", "창", "차분한 존댓말", 30, 4, 12, 13, 4, 2, 5, 14, 5, 8, "설악빙창", 2, 1, 2,
                 4, 1, BattleSpecialEffect.Freeze),
            Unit("do_arin", "도아린", Faction.Ally, "do_arin_visual.asset", new Vector2Int(8, 8), "경상 화왕도문", 16,
                 "ESTP", "불", "도", "짧고 거친 직설", 34, 3, 14, 15, 4, 1, 7, 14, 6, 11, "화왕참", 1, 1, 2, 6, 2,
                 BattleSpecialEffect.BreakGuard),
            Unit("jin_seoyul", "진서율", Faction.Ally, "jin_seoyul_visual.asset", new Vector2Int(10, 8), "경성 천뢰봉문",
                 15, "ENTP", "전기", "봉", "빠르고 장난기 있는 추리형 말투", 24, 4, 18, 19, 5, 2, 6, 12, 4, 7,
                 "천뢰봉무", 2, 1, 2, 4, 3, BattleSpecialEffect.Strike),
            Unit("seo_a", "신서아", Faction.Ally, "seo_a_visual.asset", new Vector2Int(4, 8), "전라도 남원 화접풍류문",
                 13, "ENFP", "바람/꽃", "부채", "밝고 씩씩한 막내 말투", 24, 5, 13, 14, 5, 3, 5, 13, 4, 7, "꽃바람", 3,
                 1, 2, 0, 0, BattleSpecialEffect.Mark),
            Unit("han_biyeon", "한비연", Faction.Ally, "han_biyeon_visual.asset", new Vector2Int(2, 7),
