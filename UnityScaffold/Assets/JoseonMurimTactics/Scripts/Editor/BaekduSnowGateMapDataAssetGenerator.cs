...
{
    private const string OutputFolder = "Assets/JoseonMurimTactics/ScriptableObjects/BattleMaps";
    ...
    public static void Generate()
    {
        ...
        mapData.briefingText = "보이는 석도와 계단은 이동 가능, 벽/펜스/절벽/빙판 외곽은 명시 차단된다.";
        mapData.origin = Vector2Int.zero;
        mapData.size = new Vector2Int(BaekduSnowGateBattleMapData.Width, BaekduSnowGateBattleMapData.Height);
    ...
    private static Vector3 GridToWorld(Vector2Int cell)
    {
        ...
        return new Vector3((cell.x - cell.y) * tileWidth * 0.5f,
