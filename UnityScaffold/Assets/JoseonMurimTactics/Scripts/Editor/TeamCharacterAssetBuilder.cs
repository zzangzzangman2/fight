...
public static class TeamCharacterAssetBuilder
{
    ...
    private static readonly Spec[] Team = {
        new Spec("park_sungjun", "박성준", "백두 루멘오더", 19, "ENFJ", "빛", "검",
        ...
        new Spec("baek_ryeon", "백련", "강원 설악창문", 19, "INFJ", "얼음/서리", "창", "차분한 존댓말",
        ...
        new Spec("do_arin", "도아린", "경상 화왕도문", 19, "ESTP", "불", "대도", "짧고 거친 직설",
        ...
        new Spec("jin_seoyul", "진서율", "경성 천뢰봉문", 19, "ENTP", "전기", "봉",
        ...
        new Spec("shin_seoa", "신서아", "전라도 남원 화접풍류문", 19, "ENFP", "바람/꽃", "부채",
        ...
        new Spec("han_biyeon", "한비연", "황해도 구월산 흑련암문", 19, "ISTP", "어둠/독", "단검·암기",
