...
public static class TeamCharacterAssetBuilder
{
    ...
    private static readonly Spec[] Team = {
        ...
        new Spec("baek_ryeon", "백련", "강원 설악창문", 15, "INFJ", "얼음/서리", "창", "차분한 존댓말",
        ...
        new Spec("do_arin", "도아린", "경상 화왕도문", 15, "ESTP", "불", "대도", "짧고 거친 직설",
        ...
        new Spec("shin_seoa", "신서아", "전라도 남원 화접풍류문", 15, "ENFP", "바람/꽃", "부채",
        ...
        new Spec("han_biyeon", "한비연", "황해도 구월산 흑련암문", 15, "ISTP", "어둠/독", "단검·암기",
