...
namespace JoseonMurimTactics
{
    ...
    {
        public static BattleTargetingForecast CanAttack(
            BattleTestUnit attacker,
            BattleTestUnit target,
            int range,
        ...
        public static BattleTargetingForecast CanAttackFrom(
            Vector2Int fromCell,
        ...
        public static BattleTargetingForecast CanUseSkill(
            BattleTestUnit actor,
            BattleTestUnit target,
            int range,
        ...
        public static List<Vector2Int> GetAttackableTiles(
            Vector2Int fromCell,
            int range,
            Func<Vector2Int, BattleTestTile> tileAt,
            Func<Vector2Int, bool> isInside
        ...
        private static bool BlocksMeleeEdge(BattleTestTile from, BattleTestTile to)
        {
            ...
            return IsBlockingEdge(EdgeToward(from, direction))
                || IsBlockingEdge(EdgeToward(to, -direction));
        }
