...
public static class BattleHudAssetRegistry
{
    ...
    public static readonly string[] RequiredRuntimeAssetIds =
    {
        ...
        "ui_deployment_slot_imagegen",
        "ui_deployment_strip_imagegen",
        "DeploymentSprites/deployment_park_sungjun",
        "DeploymentSprites/deployment_jin_seoyul",
        "DeploymentSprites/deployment_han_biyeon",
        "DeploymentSprites/deployment_baek_ryeon",
        "DeploymentSprites/deployment_shin_seoa",
        "DeploymentSprites/deployment_do_arin",
        "ui_phase_banner_imagegen",
        "ui_info_panel_imagegen",
        "ui_unit_status_imagegen",
        "ui_turn_order_card",
        "ui_button_normal",
        "ui_button_hover",
        "ui_button_pressed",
        ...
        "Tactical/ui_tile_move_reachable",
        "Tactical/ui_tile_move_blocked",
        "Tactical/ui_tile_current_unit",
        "Tactical/ui_path_arrow_straight",
        "Tactical/ui_path_arrow_turn",
        "Tactical/ui_path_arrow_start",
        "Tactical/ui_path_arrow_end",
        "Tactical/ui_cursor_target",
        "Tactical/ui_cursor_invalid",
        "Tactical/vfx_foot_dust_01",
        "Tactical/vfx_foot_dust_02",
        "Tactical/vfx_step_flash",
        "ui_tooltip_frame",
        "ui_toast_frame",
        "ui_hp_bar_bg",
        "ui_hp_bar_fill",
    ...
    private static readonly Dictionary<string, string> Aliases =
        ...
        {
            { "ui_battle_panel_phase_ribbon_9slice", "ui_phase_banner_imagegen" },
            ...
            { "ui_unit_status_card", "ui_unit_status_imagegen" },
            { "ui_battle_button_normal_9slice", "ui_button_normal" },
            { "ui_battle_button_hover_9slice", "ui_button_hover" },
            { "ui_battle_button_pressed_9slice", "ui_button_pressed" },
            { "ui_battle_button_disabled_9slice", "ui_button_disabled" },
