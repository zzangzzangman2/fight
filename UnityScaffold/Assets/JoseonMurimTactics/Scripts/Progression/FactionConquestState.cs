...
namespace JoseonMurimTactics
{
    ...
    public static class FactionConquestCatalog
    {
        public static readonly FactionConquestInfo[] Factions =
        {
            ...
            new FactionConquestInfo { factionId = "nine:kongtong", displayName = "공동파", group = "구파일방", recommendedLevel = 33, arcId = CampaignArcCatalog.Arc05SectHeads, finalBattleId = LongCampaignSampleIds.BattleNineKongtongMaster },
