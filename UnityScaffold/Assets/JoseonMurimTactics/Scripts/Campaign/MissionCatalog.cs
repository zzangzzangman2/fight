    ...
    public static class MissionCatalog
    {
        ...
        private static List<MissionInfo> Build()
        {
            ...
            MissionInfo m1 = new MissionInfo
            {
                ...
                difficulty = "평이",
                summary = "중원 감찰단의 현판령에 맞서 폐사당의 조선 제자들을 지키고, 감찰사 위지강을 제압한다. 해동문 연합의 첫 싸움.",
            ...
            MissionInfo m2 = new MissionInfo
            {
                ...
                difficulty = "보통",
                summary = "흩어진 조선 문파 대표들이 의주 객잔에 모인다. 암기의 고수 한비연이 처음 등장하고, 회합을 노리는 이들이 있다.",
