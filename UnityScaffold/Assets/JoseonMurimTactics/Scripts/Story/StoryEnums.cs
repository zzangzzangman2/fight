namespace JoseonMurimTactics
{
    ...
    public static class StoryEnumLabels
    {
        public static string Label(HeroDisposition d)
        {
            switch (d)
            {
                case HeroDisposition.Chivalrous: return "협도";
                case HeroDisposition.Royal: return "왕도";
                case HeroDisposition.Conqueror: return "패도";
                case HeroDisposition.Romantic: return "풍류";
        ...
        public static string Blurb(HeroDisposition d)
        {
            switch (d)
            {
                case HeroDisposition.Chivalrous: return "백성 보호와 명예. 정파적 선택과 동료 신뢰가 쉽다.";
                case HeroDisposition.Royal: return "조정과 질서, 외교. 문파 정치와 협상에 강하다.";
                case HeroDisposition.Conqueror: return "힘과 위압. 적의 굴복에 강하나 선한 동료가 경계한다.";
                case HeroDisposition.Romantic: return "대화와 도발, 설득. 박성준의 본색. 실패 시 승인도 하락.";
        ...
        public static string Label(GameDifficulty d)
        {
            switch (d)
            {
                case GameDifficulty.Story: return "이야기";
                case GameDifficulty.Murim: return "무림";
                case GameDifficulty.BloodPath: return "혈로";
                default: return d.ToString();
            }
        }
        ...
        public static string Blurb(GameDifficulty d)
        {
            switch (d)
            {
                case GameDifficulty.Story: return "적이 약하고 되돌리기가 넉넉하다. 이야기를 즐기는 분께.";
                case GameDifficulty.Murim: return "표준 난이도. 무림의 균형을 그대로 맛본다.";
                case GameDifficulty.BloodPath: return "적이 강하고 되돌리기가 제한된다. 진검승부.";
                default: return string.Empty;
            }
        }
        ...
        public static string Label(StartingArt a)
        {
            switch (a)
            {
                case StartingArt.Sword: return "검법";
        ...
        public static string Blurb(StartingArt a)
        {
            switch (a)
            {
                case StartingArt.Sword: return "정공법의 검로. 반격과 베기에 능하다.";
