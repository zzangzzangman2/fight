...
namespace JoseonMurimTactics
{
    public sealed class BattleCameraDirector : MonoBehaviour
    {
        ...
        private void LateUpdate()
        {
            ...
            battleCamera.transform.position = Vector3.Lerp(battleCamera.transform.position, targetPosition, Time.deltaTime * moveSpeed);
            battleCamera.orthographicSize = Mathf.Lerp(battleCamera.orthographicSize, targetSize, Time.deltaTime * zoomSpeed);
        }
